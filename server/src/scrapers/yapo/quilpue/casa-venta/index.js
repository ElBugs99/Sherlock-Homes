...
(async () => {
  ...
  await page.goto('https://www.yapo.cl/valparaiso/inmuebles/inmuebles/comprar?comuna=quilpue&descripcion=true&tipo-inmueble=casa&pagina=1', { timeout: 60000 });
  ...
  for (let pageNumber = 1; pageNumber <= lastpage; pageNumber++) {
    await page.goto(`https://www.yapo.cl/valparaiso/inmuebles/inmuebles/comprar?comuna=quilpue&descripcion=true&tipo-inmueble=casa&pagina=${pageNumber}`);
